...
exports.sendStatusUpdateEmail = exports.sendNewsletterConfirmation = exports.sendApplicationConfirmation = exports.sendApplicationNotification = exports.sendContactNotification = void 0;
...
const sendContactNotification = async (data) => {
    if (!process.env.SMTP_USER)
        return; // Skip jika SMTP belum dikonfigurasi
    const content = `
...
exports.sendApplicationNotification = sendApplicationNotification;
...
const sendNewsletterConfirmation = async (data) => {
    if (!process.env.SMTP_USER)
        return;
    const content = `
...
const sendStatusUpdateEmail = async (data) => {
    if (!process.env.SMTP_USER)
        return;
    const statusMap = {
