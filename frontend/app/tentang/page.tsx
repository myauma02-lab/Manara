...
const VALUES = [
  { symbol: "◎", title: "Depth", desc: "Kami menolak superfisialitas. Setiap gagasan yang kami geluti, kami geluti sepenuhnya." },
  { symbol: "◇", title: "Integrity", desc: "Kejujuran di atas kenyamanan. Kami berkata sesuai maksud dan memegang standar yang kami anut." },
...
export default function TentangManaraPage() {
  return (
    <main>
      ...
      {/* Doctrine */}
      <div style={{ background: "#266c87", padding: "18px 40px", textAlign: "center" }}>
        <p style={{ fontFamily: "Georgia,serif", fontSize: "17px", fontWeight: 300, fontStyle: "italic", color: "rgba(255,255,255,0.9)", letterSpacing: "0.01em", margin: 0 }}>
      ...
      <section style={{ padding: "100px clamp(20px,5vw,40px)", background: "#F8FAFA" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "start" }}
            ...
            <div>
              <p style={{ fontSize: "11px", letterSpacing: "0.18em", textTransform: "uppercase", color: "#266c87", marginBottom: "20px" }}>Siapa Kami</p>
              <h2 style={{ fontFamily: "Georgia,serif", fontSize: "clamp(26px,3.5vw,40px)", fontWeight: 300, color: "#0F2830", lineHeight: 1.2, marginBottom: "24px" }}>
                Di persimpangan gagasan, media, dan komunitas.
              </h2>
              ...
              <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
                ...
                <Link href="/tentang/founder" style={{ display: "inline-flex", alignItems: "center", gap: "6px", border: "1px solid rgba(38,108,135,0.2)", color: "#266c87", padding: "11px 24px", borderRadius: "2px", fontSize: "13px", fontWeight: 500, letterSpacing: "0.06em", textTransform: "uppercase", textDecoration: "none" }}>
                  Tim Founder
                </Link>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              {[
                ...
                <div key={item.title} style={{ display: "flex", gap: "16px", padding: "18px 22px", background: "#fff", border: "1px solid rgba(38,108,135,0.1)", borderRadius: "4px" }}>
                  <div style={{ width: "38px", height: "38px", borderRadius: "50%", border: "1px solid rgba(38,108,135,0.15)", display: "flex", alignItems: "center", justifyContent: "center", color: "#266c87", fontSize: "15px", flexShrink: 0 }}>
                    {item.icon}
                  </div>
                  <div>
                    <p style={{ fontFamily: "Georgia,serif", fontSize: "17px", fontWeight: 400, color: "#0F2830", marginBottom: "4px" }}>{item.title}</p>
      ...
      <section style={{ padding: "100px clamp(20px,5vw,40px)", background: "#0F2830", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "800px", margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2 }}>
          <p style={{ fontSize: "11px", letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(134,175,170,0.5)", marginBottom: "20px" }}>Visi</p>
          <h2 style={{ fontFamily: "Georgia,serif", fontSize: "clamp(24px,3.5vw,44px)", fontWeight: 300, color: "#EEF4F6", lineHeight: 1.3, marginBottom: "28px" }}>
      ...
      <section style={{ padding: "100px clamp(20px,5vw,40px)", background: "#F4F7F7" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "56px" }}>
            <p style={{ fontSize: "11px", letterSpacing: "0.18em", textTransform: "uppercase", color: "#266c87", marginBottom: "14px" }}>Nilai-Nilai</p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: "16px" }}>
            {VALUES.map(v => (
              <div key={v.title} style={{ padding: "32px 28px", background: "#fff", border: "1px solid rgba(38,108,135,0.1)", borderRadius: "4px" }}>
                <div style={{ width: "40px", height: "40px", borderRadius: "50%", border: "1px solid rgba(38,108,135,0.15)", display: "flex", alignItems: "center", justifyContent: "center", color: "#266c87", fontSize: "16px", marginBottom: "18px" }}>
                  {v.symbol}
                </div>
                <h3 style={{ fontFamily: "Georgia,serif", fontSize: "24px", fontWeight: 300, color: "#0F2830", marginBottom: "10px" }}>{v.title}</h3>
      ...
      <section style={{ padding: "100px clamp(20px,5vw,40px)", background: "#F8FAFA" }}>
        <div style={{ maxWidth: "680px", margin: "0 auto" }}>
          <div style={{ marginBottom: "48px" }}>
            <p style={{ fontSize: "11px", letterSpacing: "0.18em", textTransform: "uppercase", color: "#266c87", marginBottom: "14px" }}>Perjalanan</p>
            <h2 style={{ fontFamily: "Georgia,serif", fontSize: "clamp(26px,4vw,44px)", fontWeight: 300, color: "#0F2830" }}>Jejak langkah Manara.</h2>
          </div>
          <div style={{ position: "relative" }}>
            <div style={{ position: "absolute", left: "56px", top: 0, bottom: 0, width: "1px", background: "rgba(38,108,135,0.12)" }} />
            {TIMELINE.map((item, i) => (
              <div key={i} style={{ display: "flex", gap: "24px", marginBottom: "40px", position: "relative" }}>
                <div style={{ width: "112px", flexShrink: 0, textAlign: "right" }}>
                  <span style={{ fontFamily: "Georgia,serif", fontSize: "17px", fontWeight: 300, color: "#266c87" }}>{item.year}</span>
                </div>
                <div style={{ width: "12px", height: "12px", borderRadius: "50%", background: "#266c87", border: "3px solid #F8FAFA", flexShrink: 0, marginTop: "4px", position: "relative", zIndex: 2 }} />
                <div style={{ flex: 1 }}>
                  <h3 style={{ fontFamily: "Georgia,serif", fontSize: "19px", fontWeight: 400, color: "#0F2830", marginBottom: "6px" }}>{item.title}</h3>
                  <p style={{ fontSize: "14px", fontWeight: 300, color: "#7A9AA5", lineHeight: 1.8 }}>{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* CTA */}
      <section style={{ padding: "100px clamp(20px,5vw,40px)", background: "#0F2830", textAlign: "center" }}>
        <div style={{ maxWidth: "560px", margin: "0 auto" }}>
          <h2 style={{ fontFamily: "Georgia,serif", fontSize: "clamp(26px,4vw,44px)", fontWeight: 300, color: "#EEF4F6", lineHeight: 1.2, marginBottom: "18px" }}>
            Ingin menjadi bagian dari Manara?
          </h2>
          <p style={{ fontSize: "16px", fontWeight: 300, color: "rgba(134,175,170,0.45)", lineHeight: 1.85, marginBottom: "36px" }}>
            Bergabunglah sebagai Manapeople, kontribusikan tulisanmu, atau hubungi kami untuk kolaborasi.
          </p>
          <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/manapeople" style={{ background: "#266c87", color: "#fff", padding: "13px 28px", fontSize: "13px", fontWeight: 500, letterSpacing: "0.06em", textTransform: "uppercase", borderRadius: "2px", textDecoration: "none" }}>
              Daftar Manapeople
            </Link>
            <Link href="/#contact" style={{ border: "1px solid rgba(38,108,135,0.3)", color: "rgba(134,175,170,0.65)", padding: "13px 28px", fontSize: "13px", fontWeight: 500, letterSpacing: "0.06em", textTransform: "uppercase", borderRadius: "2px", textDecoration: "none" }}>
              Hubungi Kami
            </Link>
          </div>
        </div>
