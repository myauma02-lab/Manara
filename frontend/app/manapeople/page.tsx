      ...
      <div style={{ paddingTop: "100px", paddingBottom: "100px", background: "#F4F7F7", minHeight: "100vh" }}>
        <div style={{ maxWidth: "680px", margin: "0 auto", padding: "0 clamp(20px,5vw,32px)" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "56px" }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", border: "1px solid rgba(38,108,135,0.2)", padding: "8px 20px", borderRadius: "2px", fontSize: "11px", fontWeight: 500, letterSpacing: "0.14em", textTransform: "uppercase", color: "#266c87", marginBottom: "28px" }}>
            ...
            <p style={{ fontSize: "clamp(14px,3.5vw,16px)", fontWeight: 300, color: "#7A9AA5", lineHeight: 1.85, maxWidth: "480px", margin: "0 auto 6px" }}>
          ...
          {loading ? (
            ...
            <div style={{ background: "#fff", border: "1px solid rgba(38,108,135,0.1)", borderRadius: "4px", padding: "clamp(40px,8vw,80px) clamp(24px,6vw,40px)", textAlign: "center" }}>
              <p style={{ fontFamily: "Georgia,serif", fontSize: "clamp(20px,5vw,26px)", color: "#7A9AA5", marginBottom: "12px" }}>
                Rekrutmen Sedang Ditutup
              </p>
              <p style={{ fontSize: "clamp(13px,3.5vw,15px)", fontWeight: 300, color: "#B8CDD2", lineHeight: 1.8 }}>
            ...
            <div style={{ background: "#fff", border: "1px solid rgba(38,108,135,0.1)", borderRadius: "4px", padding: "clamp(40px,8vw,80px) clamp(24px,6vw,40px)", textAlign: "center" }}>
              ...
              <p style={{ fontFamily: "Georgia,serif", fontSize: "clamp(22px,5vw,28px)", fontWeight: 300, color: "#0F2830", marginBottom: "10px" }}>
                Lamaran Terkirim!
              </p>
              <p style={{ fontSize: "clamp(13px,3.5vw,15px)", fontWeight: 300, color: "#7A9AA5", marginBottom: "28px", lineHeight: 1.8 }}>
            ...
            <form onSubmit={handleSubmit} style={{ background: "#fff", border: "1px solid rgba(38,108,135,0.1)", borderRadius: "4px", padding: "clamp(24px,6vw,48px)" }}>
              ...
              {/* Batch info */}
              <div style={{ borderBottom: "1px solid rgba(38,108,135,0.08)", paddingBottom: "20px", marginBottom: "28px" }}>
                <h2 style={{ fontFamily: "Georgia,serif", fontSize: "clamp(18px,4vw,22px)", fontWeight: 300, color: "#0F2830", marginBottom: "6px" }}>
                  {recruitment.batchName}
                </h2>
                <p style={{ fontSize: "14px", fontWeight: 300, color: "#7A9AA5" }}>{recruitment.description}</p>
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}
                  ...
                  <div>
                    ...
                    <input value={form.phone} onChange={e => setForm(f => ({ ...f, phone: e.target.value }))} placeholder="08xx xxxx xxxx" style={inputStyle} />
                  </div>
                  <div>
                    <label style={{ display: "block", fontSize: "11px", fontWeight: 500, letterSpacing: "0.1em", textTransform: "uppercase", color: "#7A9AA5", marginBottom: "7px" }}>
                      Posisi <span style={{ color: "#266c87" }}>*</span>
                    </label>
                    <select value={form.position} onChange={e => setForm(f => ({ ...f, position: e.target.value }))} required style={{ ...inputStyle, appearance: "none", cursor: "pointer" }}>
                ...
                <div>
                  ...
                  <textarea value={form.motivation} onChange={e => setForm(f => ({ ...f, motivation: e.target.value }))} required rows={5} placeholder="Ceritakan mengapa kamu ingin bergabung dengan Manara..." style={{ ...inputStyle, resize: "vertical" }} />
                </div>
