  ...
  if (!project) return (
    <main>
      ...
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", paddingTop: "80px", textAlign: "center", padding: "120px 24px" }}>
        ...
        <Link href="/proyek" style={{ color: "#266c87", fontSize: "14px", textDecoration: "none" }}>← Kembali ke Proyek</Link>
      </div>
      <Footer />
    </main>
  );
    ...
    <main>
      ...
      <div style={{ background: "#F4F7F7", paddingBottom: "120px" }}>
        <div style={{ maxWidth: "860px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <Link href="/proyek" style={{ display: "inline-block", fontSize: "12px", color: "#B8CDD2", textDecoration: "none", marginBottom: "32px", marginTop: "32px" }}>
            ← Kembali ke Proyek
          </Link>
